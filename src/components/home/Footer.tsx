    ...
    <footer className={`bg-gray-800 text-white py-12 ${className}`}>
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Transformando la educación con tecnología avanzada e inteligencia artificial.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/pricing" className="text-gray-400 hover:text-white transition-colors">Planes</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} TestFlow. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
